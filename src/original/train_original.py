...
def main():
    ...
    CONFIG = {
        ...
        'output_dir': '/Users/wuleyan/Desktop/大创_我自己的代码保留一份/Defect_Formation_Energy_Prediction/checkpoints/original_',
        'batch_size': 32,      
        'epochs': 50,
        'lr': 1e-4,            
        'hidden_dim': 64,      
        ...
        'n_global': 1,
        'seed': 42,
        'resume_path': '/Users/wuleyan/Desktop/大创_我自己的代码保留一份/Defect_Formation_Energy_Prediction/checkpoints/original_/latest_model.pth'
    }
