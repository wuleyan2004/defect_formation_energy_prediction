...
def get_test_predictions():
    ...
    CONFIG = {
        ...
        'checkpoint_path': '/Users/wuleyan/Desktop/大创_我自己的代码保留一份/Defect_Formation_Energy_Prediction/checkpoints/original_/result_visualize/best_model.pth',
        'batch_size': 32,
        'seed': 42
    }
...
def main():
    ...
    try:
        if len(all_targets) > 0:
            ...
            plt.scatter(all_targets, all_preds, alpha=0.5, s=10, c='green', edgecolors='none')
            ...
            plt.title(f'Ours Test Parity\nMAE={mae:.3f} eV, RMSE={rmse:.3f} eV')
            plt.grid(True, which='both', linestyle='--', linewidth=0.5)
            plt.axis('square')
            
            output_plot = '/Users/wuleyan/Desktop/大创_我自己的代码保留一份/Defect_Formation_Energy_Prediction/Final_test_original.png'
